...
.field private l:Landroid/support/v4/i/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/i/m",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/j;->d:[I
    ...
    sput-object v0, Landroid/support/v7/widget/j;->e:[I
    ...
    sput-object v0, Landroid/support/v7/widget/j;->f:[I
...
.method private static a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {v0, p1}, Landroid/support/v7/widget/j;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->m:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v0, p0, Landroid/support/v7/widget/j;->n:Ljava/util/WeakHashMap;
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/i/m;->c(ILjava/lang/Object;)V
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bf;[I)V
    ...
    :goto_2
    invoke-static {v0, v1, p2}, Landroid/support/v7/widget/j;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_4
    sget-object v1, Landroid/support/v7/widget/j;->a:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/j$c;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/j;->k:Landroid/support/v4/i/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->k:Landroid/support/v4/i/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v5, Landroid/support/v7/widget/j;->a:Landroid/graphics/PorterDuff$Mode;

    sget-object v4, Landroid/support/v7/widget/j;->d:[I
    ...
    invoke-static {v1, v6}, Landroid/support/v7/widget/j;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_2
    sget-object v4, Landroid/support/v7/widget/j;->f:[I
    ...
    :cond_3
    sget-object v4, Landroid/support/v7/widget/j;->g:[I
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->m:Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->n:Ljava/util/WeakHashMap;
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/j;->o:Landroid/util/TypedValue;
    ...
    invoke-static {v1}, Landroid/support/v7/widget/j;->a(Landroid/util/TypedValue;)J

    move-result-wide v2

    invoke-direct {p0, p1, v2, v3}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v2, v3, v0}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/j;->l:Landroid/support/v4/i/m;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/widget/j;->l:Landroid/support/v4/i/m;

    invoke-virtual {v0, p2}, Landroid/support/v4/i/m;->a(I)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->k:Landroid/support/v4/i/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->l:Landroid/support/v4/i/m;
    ...
    :cond_4
    iget-object v2, p0, Landroid/support/v7/widget/j;->o:Landroid/util/TypedValue;
    ...
    invoke-static {v2}, Landroid/support/v7/widget/j;->a(Landroid/util/TypedValue;)J
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->l:Landroid/support/v4/i/m;

    const-string v2, "appcompat_skip_skip"

    invoke-virtual {v1, p2, v2}, Landroid/support/v4/i/m;->c(ILjava/lang/Object;)V
    ...
    iget-object v7, p0, Landroid/support/v7/widget/j;->l:Landroid/support/v4/i/m;

    invoke-virtual {v7, p2, v0}, Landroid/support/v4/i/m;->c(ILjava/lang/Object;)V

    iget-object v7, p0, Landroid/support/v7/widget/j;->k:Landroid/support/v4/i/a;
...
.method private e(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/j;->e(Landroid/content/Context;)V
...
.method a(Landroid/content/Context;Landroid/support/v7/widget/bj;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-direct {p0, p1, p3, v1, v0}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->m:Ljava/lang/Object;
