...
.method private static a()I
    ...
    sget v0, Landroid/support/v7/a/a$h;->notification_action:I
...
.method public static a(Landroid/content/Context;)I
    ...
    sget v1, Landroid/support/v7/a/a$d;->notification_top_pad:I
    ...
    sget v2, Landroid/support/v7/a/a$d;->notification_top_pad_large_text:I
...
.method private static a(ZI)I
    ...
    sget v0, Landroid/support/v7/a/a$h;->notification_template_big_media_narrow_custom:I
    ...
    sget v0, Landroid/support/v7/a/a$h;->notification_template_big_media_custom:I
...
.method public static a(Landroid/content/Context;IIII)Landroid/graphics/Bitmap;
    ...
    sget v0, Landroid/support/v7/a/a$e;->notification_icon_background:I
...
.method private static a(Landroid/content/Context;Landroid/support/v4/b/al$a;)Landroid/widget/RemoteViews;
    ...
    iget-object v0, p1, Landroid/support/v4/b/al$a;->d:Landroid/app/PendingIntent;
    ...
    sget v1, Landroid/support/v7/a/a$f;->action_image:I
    ...
    sget v5, Landroid/support/v7/a/a$c;->notification_action_color_filter:I
    ...
    sget v1, Landroid/support/v7/a/a$f;->action_text:I

    iget-object v3, p1, Landroid/support/v4/b/al$a;->c:Ljava/lang/CharSequence;

    invoke-virtual {v2, v1, v3}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    if-nez v0, :cond_0

    sget v0, Landroid/support/v7/a/a$f;->action_container:I

    iget-object v1, p1, Landroid/support/v4/b/al$a;->d:Landroid/app/PendingIntent;
    ...
    iget-object v1, p1, Landroid/support/v4/b/al$a;->c:Ljava/lang/CharSequence;
...
.method private static a(Landroid/content/Context;Landroid/support/v4/b/ap$a;)Landroid/widget/RemoteViews;
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation

    invoke-virtual {p1}, Landroid/support/v4/b/ap$a;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p1}, Landroid/support/v4/b/ap$a;->a()I
    ...
    invoke-virtual {p1}, Landroid/support/v4/b/ap$a;->b()Ljava/lang/CharSequence;
...
.method public static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZ)Landroid/widget/RemoteViews;
    ...
    sget v3, Landroid/support/v7/a/a$f;->notification_background:I

    const-string v7, "setBackgroundResource"

    sget v8, Landroid/support/v7/a/a$e;->notification_bg_low:I

    invoke-virtual {v2, v3, v7, v8}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    sget v3, Landroid/support/v7/a/a$f;->icon:I

    const-string v7, "setBackgroundResource"

    sget v8, Landroid/support/v7/a/a$e;->notification_template_icon_low_bg:I
    ...
    sget v3, Landroid/support/v7/a/a$d;->notification_right_icon_size:I

    invoke-virtual {v6, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v7, Landroid/support/v7/a/a$d;->notification_small_icon_background_padding:I
    ...
    sget v3, Landroid/support/v7/a/a$f;->title:I
    ...
    sget v3, Landroid/support/v7/a/a$f;->text:I
    ...
    sget v3, Landroid/support/v7/a/a$f;->info:I
    ...
    sget v3, Landroid/support/v7/a/a$d;->notification_subtext_size:I
    ...
    :goto_a
    sget v4, Landroid/support/v7/a/a$f;->right_side:I
    ...
    sget v8, Landroid/support/v7/a/a$e;->notification_bg:I
    ...
    sget v8, Landroid/support/v7/a/a$e;->notification_template_icon_bg:I
    ...
    sget v3, Landroid/support/v7/a/a$d;->notification_large_icon_width:I

    invoke-virtual {v6, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v7, Landroid/support/v7/a/a$d;->notification_big_circle_margin:I
    ...
    sget v7, Landroid/support/v7/a/a$d;->notification_small_icon_size_as_large:I
    ...
    sget v7, Landroid/support/v7/a/a$f;->icon:I
    ...
    sget v3, Landroid/support/v7/a/a$g;->status_bar_notification_info_maxnum:I
    ...
    sget v4, Landroid/support/v7/a/a$i;->status_bar_notification_info_overflow:I
...
.method public static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZLjava/util/ArrayList;)Landroid/widget/RemoteViews;
    ...
    sget v1, Landroid/support/v7/a/a$f;->actions:I
    ...
    check-cast v1, Landroid/support/v4/b/al$a;

    invoke-static {p0, v1}, Landroid/support/v7/app/q;->a(Landroid/content/Context;Landroid/support/v4/b/al$a;)Landroid/widget/RemoteViews;

    move-result-object v1

    sget v6, Landroid/support/v7/a/a$f;->actions:I
    ...
    :goto_3
    sget v2, Landroid/support/v7/a/a$f;->actions:I

    invoke-virtual {v5, v2, v1}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    sget v2, Landroid/support/v7/a/a$f;->action_divider:I
...
.method public static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIILjava/util/List;ZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    check-cast v2, Landroid/support/v4/b/ap$a;

    move-object/from16 v0, p0

    invoke-static {v0, v2}, Landroid/support/v7/app/q;->a(Landroid/content/Context;Landroid/support/v4/b/ap$a;)Landroid/widget/RemoteViews;
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    sget v16, Landroid/support/v7/a/a$h;->notification_template_media_custom:I
    ...
    :cond_0
    sget v16, Landroid/support/v7/a/a$h;->notification_template_media:I
...
.method public static a(Landroid/support/v4/b/ak;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation
...
.method public static a(Landroid/content/Context;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    sget v0, Landroid/support/v7/a/a$f;->notification_main_column:I
    ...
    sget v1, Landroid/support/v7/a/a$f;->notification_main_column_container:I
...
.method private static a(Landroid/widget/RemoteViews;)V
    ...
    sget v0, Landroid/support/v7/a/a$f;->text2:I

    invoke-virtual {p0, v0, v1}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    sget v0, Landroid/support/v7/a/a$f;->text:I
...
.method private static b()I
    ...
    sget v0, Landroid/support/v7/a/a$h;->notification_action_tombstone:I
