...
# static fields
.field private static a:Landroid/support/v7/app/v;
...
.field private final d:Landroid/support/v7/app/v$a;
...
.method constructor <init>(Landroid/content/Context;Landroid/location/LocationManager;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/v;->d:Landroid/support/v7/app/v$a;

    iput-object p1, p0, Landroid/support/v7/app/v;->b:Landroid/content/Context;

    iput-object p2, p0, Landroid/support/v7/app/v;->c:Landroid/location/LocationManager;
...
.method private a(Ljava/lang/String;)Landroid/location/Location;
    ...
    iget-object v0, p0, Landroid/support/v7/app/v;->c:Landroid/location/LocationManager;
...
.method static a(Landroid/content/Context;)Landroid/support/v7/app/v;
    ...
    sget-object v0, Landroid/support/v7/app/v;->a:Landroid/support/v7/app/v;
    ...
    sput-object v2, Landroid/support/v7/app/v;->a:Landroid/support/v7/app/v;
...
.method private a(Landroid/location/Location;)V
    ...
    iget-object v10, v0, Landroid/support/v7/app/v;->d:Landroid/support/v7/app/v$a;
    ...
    iget-wide v14, v3, Landroid/support/v7/app/u;->a:J
    ...
    iget v2, v3, Landroid/support/v7/app/u;->c:I
    ...
    :goto_0
    iget-wide v0, v3, Landroid/support/v7/app/u;->b:J

    move-wide/from16 v16, v0

    iget-wide v0, v3, Landroid/support/v7/app/u;->a:J
    ...
    iget-wide v6, v3, Landroid/support/v7/app/u;->b:J
...
.method private b()Landroid/location/Location;
    ...
    iget-object v0, p0, Landroid/support/v7/app/v;->b:Landroid/content/Context;
    ...
    :goto_0
    iget-object v2, p0, Landroid/support/v7/app/v;->b:Landroid/content/Context;
...
.method private c()Z
    ...
    iget-object v0, p0, Landroid/support/v7/app/v;->d:Landroid/support/v7/app/v$a;
